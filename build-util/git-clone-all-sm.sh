...
#
# git-clone-all-sm - clone all StateMod C# repositories for new development environment setup
...
# StateMod C# GitHub repo URL root
githubRootUrl="https://github.com/OpenCDSS"

# Main StateMod C# repository
mainRepo="cdss-app-statemod-cs"
